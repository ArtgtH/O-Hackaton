      ...
      {width <= 1024 ? (
        <div className="dropdown fixed top-4 left-4 z-50 ">
          ...
          >
            ...
            <NavLink
              to="/"
              className="px-4 py-4 flex gap-2 items-center hover:bg-gray-200 transition text-gray-100 hover:text-black"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="w-80 bg-main-bg shadow fixed top-0 left-0 h-full flex flex-col py-8 ">
          <UserInfo />
          <NavLink
            to="/"
            className="px-4 py-4 flex gap-2 items-center hover:bg-gray-200 transition text-gray-100 hover:text-black"
